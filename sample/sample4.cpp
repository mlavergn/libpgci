...
// first some basic DML
  ...
  m_stmt.execute("create table dept (deptno integer, dname varchar(15), loc varchar(15), rptdate timestamp)");
...
// -------------------------------------------------------------------------
// and finally define some define variables and select our data (Note: no rebind reqd)
